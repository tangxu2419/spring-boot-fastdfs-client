 ...
 * @author tangxu
 */
public class TrackerDeleteStorageRequest extends AbstractFdfsRequest {
    ...
    public TrackerDeleteStorageRequest(String groupName, String storageIpAddr) {
        ...
        Validate.notBlank(storageIpAddr, "storage节点IP不能为空");
        this.groupName = groupName;
        this.storageIpAddr = storageIpAddr;
        head = new ProtoHead(ProtocolCommand.TRACKER_PROTO_CMD_SERVER_DELETE_STORAGE);
    }
