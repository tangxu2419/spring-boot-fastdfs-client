...
public class ConnectPoolConfig extends GenericKeyedObjectPoolConfig {
     ...
     * 默认jmx域名
     */
    public static final String FDFS_JMX_NAME_BASE = "com.vcredit.framework.fastdfs.conn:type=FdfsConnectionPool";
